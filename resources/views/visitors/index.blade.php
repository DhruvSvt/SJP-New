...
<div id="myCarousel" class="carousel slide home-slider">
    ...
    <div class="carousel-inner">
        ...
        <div class="item @if ($loop->index==0)
active
        @endif">
            <div class="nocontainer">
                <div class="row">
        ...
        <div class="container">
            ...
            <div style="text-align: center">
                ...
                <div id="owl-demo2">
                    ...
                    <div class="item">
                        <div class="testi_box">
                            <div class="testi_img"><img src="uploads/client-feedback/Simmy-Viraj.jpg" alt="Simmy Viraj">
                            </div>
                    ...
                    <div id="owl-demo3">
                        ...
                        <div class="item">
                            <div class="client_box">
                                <img src="{{ Voyager::image($row->image) }}" alt="Joyalukkas World favourite jeweller">
                            </div>
                        </div>
                        @endforeach
